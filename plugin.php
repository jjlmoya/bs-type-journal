...
function bs_journal_register_post_type()
{
...
function bs_journal_register($customType)
{
	$model = bs_journal_get_post_type();
...
function bs_journal_callback($fieldType)
{
	$model = bs_journal_get_post_type();
	$customField = $model->customFields;
...
function bs_journal_on_save($post_id)
{
